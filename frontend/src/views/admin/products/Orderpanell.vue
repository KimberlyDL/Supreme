...
<template>
    <div class="flex flex-col md:flex-row space-x-4 w-full min-h-screen">
        ...
        <div class="space-y-6">
            ...
            <div>
                <label for="product" class="block text-sm font-medium text-tBase-100 mb-2">Select Payment Type</label>
                <select id="product" v-model="paymentType" required
...
const formData = ref({
    ...
    items: [],
    discount: 0,
    paymentMethod: paymentType.value || 'cash',
