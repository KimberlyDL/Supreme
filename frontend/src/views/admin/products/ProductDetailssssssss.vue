      ...
      <div v-if="product">
        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="mt-4 flex flex-col">
              <div class="flex items-center">
                ...
                <div v-if="isSaleActive(product.sale)" class="flex items-center">
                  ...
                  <span class="ml-5 text-xl font-bold line-through text-gray-500">₱{{ product.basePrice.toFixed(2) }}</span>
                </div>
              ...
              <div v-if="product.sale && product.sale.onSale" class="mt-2 text-sm">
                ...
                <div v-else-if="isSaleUpcoming(product.sale)" class="text-yellow-600">
                  Sale starts in {{ getDaysUntilSale(product.sale) }} days ({{ formatDate(product.sale.startDate.seconds * 1000) }})
                </div>
              </div>
            </div>
                ...
                <div v-for="(variety, index) in product.varieties" :key="index"
                  ...
                  <div class="flex justify-between items-start">
                    ...
                    <div class="text-right">
                      <div v-if="variety.onSale && isVarietySaleActive(variety)" class="flex flex-col">
                        <span class="font-bold text-red-600">₱{{ variety.sale.salePrice.toFixed(2) }}</span>
                        <span class="text-sm line-through text-gray-500">₱{{ variety.price.toFixed(2) }}</span>
                      </div>
                      <div v-else class="font-bold text-gray-900">₱{{ variety.price.toFixed(2) }}</div>
                      <div :class="[
                        'text-xs mt-1',
          ...
          <div class="flex justify-between p-8 border-t border-gray-200">
            ...
            <button @click="editProduct" class="bg-primary hover:bg-primary-dark text-white font-medium py-2 px-4 rounded flex items-center">
