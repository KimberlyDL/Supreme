<template>
  <div class="px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
      <h1 class="text-2xl font-semibold text-gray-900 sm:text-3xl dark:text-white">Product Management</h1>

      <!-- Add Product Button -->
      <!-- <button @click="openAddModal"
        class="mb-4 px-4 py-2 bg-primary text-primary-foreground rounded-md hover:bg-primary/90">
        Add New Product
      </button> -->
    ...
    <AddProductModal :isOpen="isModalOpen" :isEditing="isEditing" :initialProduct="editingProduct" @close="closeModal"
      @submit="handleSubmit" />
  </div>
</template>
