<template>
  <div class="p-6 max-w-md w-full bg-white rounded-lg">
    <h3 class="text-xl font-semibold text-tBase-100 mb-6">Add New Branch</h3>
...
const nameNotTaken = (value) => {
  ...
  const existingNames = branchStore.fetchedbranches.map(branch => branch.name.toLowerCase());
